        ...
        <div className="absolute top-[60px] w-full">
            {
                !open ? (
                    ...
                    <div className="flex flex-col gap-[10px] justify-center bg-[#00ae9b] border-4 border-solid border-white px-2.5 rounded-tr-[20px] rounded-br-[20px] [@media(max-width:500px)]:w-[70%] w-[450px] bottom-0 left-0 pt-[10px]">
                        ...
                        <a href="/principal" className="text-white text-lg [@media(max-width:500px)]:text-[20px] text-[30px] border-dashed border-b-2 border-white">Videos</a>
                        ...
                        }} className="cursor-pointer text-white text-lg [@media(max-width:500px)]:text-[20px] text-[30px]">Cerrar sesion   </div>
                    </div>
                )
            }
        </div>
